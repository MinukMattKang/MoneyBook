...
<script>
	...
	function addComment(idx, content) {	
		String content = findById(comment).value;
...
<!-- 					댓글   							-->
				...
				<div class="container" align="center" style="padding: 30px; margin-top:-60px;">
					<div class="card border-primary mb-3">
<!-- 						<form action="processAddComment.jsp" method="post" accept-charset="UTF-8"> -->
							<table style="margin: 30px; margin-bottom:15px; margin-top: 15px;">
								...
								<tbody>
									<tr>
										<td colspan="7"><textarea id="comment" class="form-control" maxlength="2048" style="height: 80px;" name="content"></textarea></td>
									</tr>
									<tr>
										<td colspan="7" align="right">
<!-- 											<button type="submit" class="btn btn-primary" style="margin-top: 12px" value="버튼"></button> -->
											<a type="button" class="btn btn-primary" style="margin-top: 12px" href="#">버튼</a>
										</td>
									</tr>
								</tbody>
							</table>
<!-- 						</form> -->
						...
						<table class="card" style="display: flex; margin: 30px; margin-bottom:15px; margin-top: 0px; min-height: 64px">
							<tr>
								<td>
									<input value="작성자 아이디<%= i %>" readonly="readonly" style="width: 140px; margin-left:10px; margin-top:13px; height: 36px" />
								</td>
								<td>
									<input value="이곳은 댓글 내용입니다. 이곳은 댓글 내용입니다. 이곳은 댓글 내용입니다." readonly="readonly" style="width: 780px;  margin-top:12px; height: 37px" />
								</td>
								<td>
									<input value="2022-05-1<%= i %>" readonly="readonly" style="width: 100px;  margin-top:12px; height: 37px"/>
								</td>
								<td>
									<button class="btn btn-primary" style="margin-top: 12px" onclick="#">수정</button>
									<button class="btn btn-primary" style="margin-top: 12px" onclick="#">삭제</button>
								</td>
							</tr>
						</table>
						<% } %>
