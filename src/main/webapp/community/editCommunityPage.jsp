	...
	<div class="container mt-5">
		<c:choose>
			...
			<div class="container" align="center" style="padding: 30px">
				<form method="post" action="processEditCommunity.jsp" accept-charset="UTF-8">
					<div class="card border-primary mb-3">
						<table style="margin: 30px; margin-bottom:15px">
							...
							<tobody>
								...
								<tr>
									<td><textarea class="form-control" maxlength="2048" style="height: 300px;" name="content" ><%= (rs.getString("CONTENT")).trim() %></textarea></td>
								</tr>
								<tr>
