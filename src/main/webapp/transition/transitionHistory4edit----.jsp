...
<%-- 				<a href="#" role="button" class="btn" onclick="bring4Edit('<%= rs.getString("idx"), rs.getString("bank") %>')"><img src="./resources/images/edit.png" width=20 height=20></a> --%>
<%-- 				<a href="#" role="button" class="btn"  onclick="deleteContent('<%= rs.getString("idx") %>')"><img src="./resources/images/delete.png" width=20 height=20></a> --%>
				</td>
...
<script>
	function editContent(idx) {
		location.href = "./editTransitionHistory2.jsp?idx=" + idx;
	}
