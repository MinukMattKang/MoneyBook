...
<div class="form-group mt-3">
	<label class="form-label mt-4"><h3>검색조건</h3></label>
	<div class="form-group">
		<form name="newTransitionHistory" action="./searchAccountPage2.jsp" method="post">
			<div class="input-group mb-1" role="group" aria-label="Basic radio toggle button group">
				<span class="input-group-text">거래유형</span> 
				<input type="radio" class="btn-check" name="type" id="income" value="입금"> 
				<label class="btn btn-outline-primary" for="income">입금</label> 
				<input type="radio" class="btn-check" name="type" id="expenditure" value="출금"> 
				...
				<input type="text" class="form-control" name="datetime" placeholder="YYYY/MM/DD">
